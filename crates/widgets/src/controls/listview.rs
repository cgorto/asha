...
/// Scrollable list container, spawnable as a scene component with
/// [`FeathersListViewProps`].
#[derive(SceneComponent, Default, Clone, Reflect)]
#[scene(FeathersListViewProps)]
#[reflect(Component, Clone, Default)]
pub struct FeathersListView;

/// Properties for a [`FeathersListView`] scene.
...
impl FeathersListView {
    /// List-view scene function.
    pub fn scene(props: FeathersListViewProps) -> impl Scene {
        bsn! {
            // Outer frame holds the scrollbar.
            Node {
...
/// Selectable list row, spawnable as a scene component.
#[derive(SceneComponent, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
pub struct FeathersListRow;

impl FeathersListRow {
    /// List-row scene function.
...
/// Marker for the active-row outline.
...
/// Registers list-row styling systems.
