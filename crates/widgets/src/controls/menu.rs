...
use bevy_ui::{
    AlignItems, AlignSelf, BoxShadow, Display, FlexDirection, GlobalZIndex, InteractionDisabled,
    JustifyContent, Node, OverrideClip, PositionType, Pressed, UiRect, px,
};
use bevy_ui_widgets::{
...
/// Menu container anchoring its button and popover.
///
/// Spawnable as a scene component.
...
/// Menu button with an optional dropdown arrow, spawnable as a scene component
/// with [`FeathersMenuButtonProps`].
...
/// Properties for a [`FeathersMenuButton`] scene.
...
/// Menu popup widget, spawnable as a scene component.
...
/// Menu item with optional [`FeathersMenuItemProps`], spawnable as a scene component.
#[derive(SceneComponent, Default, Clone)]
...
/// Properties for a [`FeathersMenuItem`] scene.
...
/// Decorative divider between menu items, spawnable as a scene component.
#[derive(SceneComponent, Default, Clone, Reflect)]
#[reflect(Component, Default, Clone)]
...
/// Registers menu styling systems.
