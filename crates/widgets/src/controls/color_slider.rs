...
use bevy_ui::{
    ...
    UiRect, UiTransform, Val2, ZIndex, percent, px,
};
use bevy_ui_widgets::{
...
use crate::{
    alpha_pattern::AlphaPattern, cursor::EntityCursor, focus::FocusIndicator, palette,
...
/// Color channel edited by a slider.
...
pub enum ColorChannel {
    ...
    Green,
    /// RGB blue channel (0..=1).
    Blue,
    /// Hue channel (0..=360).
    HslHue,
    /// Chroma or saturation channel (0..=1).
    HslSaturation,
...
impl ColorChannel {
    ...
    /// Returns gradient endpoints and midpoint for the base color.
...
/// Stores color channels held constant by the slider.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Default, Clone)]
pub struct SliderBaseColor(pub Color);

/// Color slider, spawnable as a scene component with optional
...
/// Properties for a [`FeathersColorSlider`] scene.
#[derive(Clone)]
pub struct FeathersColorSliderProps {
    /// Slider current value
    pub value: f32,
    /// Color component being edited.
...
/// Spawns a color slider.
///
/// # Arguments
///
/// * `props` - construction properties for the slider.
/// `overrides` augments the default slider components.
///
/// # Emitted events
///
/// * [`bevy_ui_widgets::ValueChange<f32>`] when the slider value is changed.
...
/// Registers color-slider styling systems.
