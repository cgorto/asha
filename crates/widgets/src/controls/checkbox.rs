...
use bevy_ui::{
    ...
    Node, PositionType, Pressed, UiRect, UiTransform, px,
};
...
/// Checkbox widget, spawnable as a scene component with optional
/// [`FeathersCheckboxProps`].
///
/// # Emitted events
...
/// Properties for a [`FeathersCheckbox`] scene.
pub struct FeathersCheckboxProps {
    /// Label entities arranged in a flexbox.
    ...
    fn scene(props: FeathersCheckboxProps) -> impl Scene {
        bsn! {
            ...
            Children [(
                ...
                FocusIndicator
                Children [(
                    // Rotated L-shaped border forms the checkmark.
                    Node {
...
/// Checkbox frame containing the control and label.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
struct CheckboxFrame;

/// Checkbox outline marker.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
struct CheckboxOutline;

/// Checkbox checkmark marker.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
struct CheckboxMark;
...
/// Spawns a checkbox.
///
/// Add a caption by appending a child entity.
///
/// # Emitted events
/// * [`bevy_ui_widgets::ValueChange<bool>`] with the new value when the checkbox changes state.
///
...
/// Registers checkbox styling systems.
