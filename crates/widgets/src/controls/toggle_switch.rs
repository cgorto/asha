...
use bevy_ui::{
    BorderRadius, Checked, InteractionDisabled, Node, PositionType, Pressed, UiRect, percent, px,
};
...
/// Toggle switch widget, spawnable as a scene component.
///
/// # Emitted events
...
/// Spawns a toggle switch.
///
/// # Arguments
/// * `props` - construction properties for the toggle switch.
/// `overrides` augments the default toggle components.
///
/// # Emitted events
/// * [`bevy_ui_widgets::ValueChange<bool>`] with the new value when the toggle switch changes state.
///
...
/// Registers toggle-switch styling systems.
