...
/// Radio widget, spawnable as a scene component with optional
/// [`FeathersRadioProps`].
///
/// # Emitted events
...
/// Properties for a [`FeathersRadio`] scene.
...
/// Radio outline marker.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
struct RadioOutline;

/// Radio checkmark marker.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
struct RadioMark;

/// Spawns a radio button.
///
...
/// Registers radio styling systems.
