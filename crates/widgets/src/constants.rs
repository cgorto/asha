...
pub mod fonts {
    ...
    pub const REGULAR: &str = "embedded://widgets/assets/fonts/FiraSans-Regular.ttf";
    /// Regular italic font path
    pub const ITALIC: &str = "embedded://widgets/assets/fonts/FiraSans-Italic.ttf";
    /// Bold font path
    pub const BOLD: &str = "embedded://widgets/assets/fonts/FiraSans-Bold.ttf";
    /// Bold italic font path
    pub const BOLD_ITALIC: &str = "embedded://widgets/assets/fonts/FiraSans-BoldItalic.ttf";
    /// Monospace font path
    pub const MONO: &str = "embedded://widgets/assets/fonts/FiraMono-Medium.ttf";
}

/// Icon paths
pub mod icons {
    /// Downward-pointing chevron
    pub const CHEVRON_DOWN: &str = "embedded://widgets/assets/icons/chevron-down.png";
    /// Right-pointing chevron
    pub const CHEVRON_RIGHT: &str = "embedded://widgets/assets/icons/chevron-right.png";
    /// Diagonal Cross
    pub const X: &str = "embedded://widgets/assets/icons/x.png";
}
