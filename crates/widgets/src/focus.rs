...
use bevy_ui::{Outline, UiSystems, px};

use crate::{theme::UiTheme, tokens};

/// Marker inserted on an entity to show focus when it or an ancestor is focused.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
pub struct FocusIndicator;

/// Marker inserted on an entity to show focus when it or a descendant is focused.
#[derive(Component, Default, Clone, Reflect)]
#[reflect(Component, Clone, Default)]
...
/// Registers focus-outline systems.
